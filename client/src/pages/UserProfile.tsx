...
const UserProfile =()=> {
    return(
        <div className="w-[428px] h-[926px] relative overflow-hidden rounded-sm bg-white border border-white/10">
            ...
            />
            <div className="w-[428px] h-[315px] absolute left-[-1px] top-[-1px] rounded-bl-[15px] rounded-br-[15px] bg-[#ffd1d1]" />
...
<<<<<<< Updated upstream
                className="absolute left-[374px] top-[71px]"
...
>>>>>>> Stashed changes
            ...
            <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
<<<<<<< Updated upstream
                className="absolute left-[374px] top-20"
                preserveAspectRatio="xMidYMid meet"
            >
                <line y1="1.5" x2={31} y2="1.5" stroke="black" stroke-width={3} />
=======
...
>>>>>>> Stashed changes
            ...
            <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
<<<<<<< Updated upstream
                className="absolute left-[374px] top-[90px]"
                preserveAspectRatio="xMidYMid meet"
            >
                <line y1="1.5" x2={31} y2="1.5" stroke="black" stroke-width={3} />
=======
...
<<<<<<< Updated upstream
            ...
            <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="absolute left-[151px] top-[252px]"
                preserveAspectRatio="xMidYMid meet"
            >
...
=======
            ...
            <div className="relative left-[25%] top-[-25px]">
                ...
                <p className="absolute left-[174px] top-[383px] text-[30px] font-bold text-left text-black">고승민</p>
                <p className="absolute left-20 top-[477px] text-[15px] font-bold text-left text-black">게시물</p>
                <p className="absolute left-[92px] top-[451px] text-[15px] font-bold text-left text-black">51</p>
                <p className="absolute left-[201px] top-[451px] text-[15px] font-bold text-left text-black">
                    237
