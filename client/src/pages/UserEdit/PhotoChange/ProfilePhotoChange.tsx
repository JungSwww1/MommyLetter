...
import {profilePhotoChangeAPI} from "@/apis/profile/ProfileAPI";
...
const ProfilePhotoChange = () => {
    ...
    const profileChange = async () => {
        ...
        imgFiles.forEach(file => formData.append('profileImage', file))

       profilePhotoChangeAPI(userId,formData).then(response => {
    ...
    return (
        <div>
            <BottomUpModal writeButton={writeButton} modalId={9}>
                <div>
                    <div className="flex justify-between">
                        <Label htmlFor="input-file1">업로드</Label><p className="text-gray-400">※ 10MB 이하 png,jpg,jpeg파일</p>
                        <input type="file" id="input-file1"
                               className="signup-profileImg-input1"
