    ...
    return (<div className="w-[100%]">
            {nicknameList.map((nicknameItem, index) => (
                <div key={index} className="flex justify-between items-center ml-5 h-[13%] w-[100%] ">
                    <img className="w-[15%]  rounded-full hover:scale-125 duration-300" src={`${nicknameItem.profilePhoto  ? "/profileimages/"+nicknameItem.profilePhoto.substring(88,) : "/assets/images/default_image.png"}`} />
