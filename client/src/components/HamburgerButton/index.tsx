...
const HamburgerButton = ({children}: { children: ReactNode }) => {
    ...
    return (<HamburgerLayout className="dropdown dropdown-end ">
            <div className="drawer drawer-end">
                ...
                <div className="h-[100%] drawer-side">
                    ...
                    <ul className="menu w-[30%] min-h-full bg-base-200 text-base-content">
                        <div
                            className={`${isBlue ?  "text-white bg-doctor" : "text-pointColor bg-user"} flex flex-row items-center relative font-bold h-[100%] bottom-1 h-[10%]  w-[100%]  rounded-xl`}>
                            <img className="w-[20%] mr-3" src="/assets/images/default_image.png"/>{nickname}</div>
                        <div className="h-[80%]">
                            <Item><Link to="/profile"><Profile/>내 정보</Link></Item>
                            {!isDoctor && <Item><Link to="/diary/mom"><Diary fill={"black"}/>나의일기</Link></Item>}
                            ...
                            {isDoctor && <Item><Link to="/history"><Book/>진료기록</Link></Item>}
                        ...
                        <div
                            ...
                            <Button
                                className={` font-bold hover:text-black "text-pointColor" h-[20%] w-[100%]`}
